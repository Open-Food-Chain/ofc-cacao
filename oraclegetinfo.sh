...
curl --user $BATCH_SMARTCHAIN_NODE_USERNAME:$BATCH_SMARTCHAIN_NODE_PASSWORD --data-binary '{"jsonrpc": "1.0", "id":"curltest", "method": "oraclesinfo", "params": ["0746e53cf7b4fb6793ce4d1f958b80a649760f1f8f3b7228750acb27cd4ce22b"] }' -H 'content-type: text/plain;' http://$BATCH_SMARTCHAIN_NODE_IPV4_ADDR:$BATCH_SMARTCHAIN_NODE_RPC_PORT/
