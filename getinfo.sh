...
curl --data-binary '{"jsonrpc": "1.0", "id":"curltest", "method": "getinfo", "params": [] }' -H 'content-type: text/plain;' http://$BATCH_SMARTCHAIN_NODE_USERNAME:$BATCH_SMARTCHAIN_NODE_PASSWORD@$BATCH_SMARTCHAIN_NODE_IPV4_ADDR:$BATCH_SMARTCHAIN_NODE_RPC_PORT/
